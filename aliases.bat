...
doskey codin=cmd /c "if not exist C:\script\lib\ mkdir C:\script\lib\ $T cd C:\script\lib\ $T wget https://github.com/oscarmacas/files/raw/main/codes.zip $T 7z x codes.zip -ocodes"
