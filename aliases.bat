...
doskey udalias=curl https://raw.githubusercontent.com/oscarmacas/scripts/main/aliases.bat$GC:\aliases\aliases.bat $T echo . $T echo ========================= $T echo == $T echo == $T echo ==            El archivo alias ha sido actualizado. $T echo == $T echo == $T echo ========================= $T cmd
