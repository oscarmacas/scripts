...
doskey udalias=curl https://raw.githubusercontent.com/oscarmacas/scripts/main/aliases.bat$GC:\aliases\aliases.bat $T color 01 $T echo El archivo alias ha sido actualizado. $T cmd
